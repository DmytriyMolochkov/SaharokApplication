...
namespace SaharokServer.Encryption
{
    public class MyAes
    {
        ...
        public void ExportParameters(Stream stream)
        {
            ...
            myRijndael.Key = Convert.FromBase64String("lL4VnrEhkZuAMbo72TCc3s3ZkBvmL2frEm8ZdrHmF1M=");
            myRijndael.IV = Convert.FromBase64String("S7u9tmMreePtmwfyHsrbMQ==");
        ...
        public void ImportParameters(Stream stream)
        {
            ...
            byte[][] parameters = (byte[][])RSA.DencryptFromStream(stream);
